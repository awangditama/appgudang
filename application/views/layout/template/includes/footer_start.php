...
<script src="<?php echo base_url();?>assets2/js/popper.min.js"></script><!-- Popper for Bootstrap -->
...
<!-- Counter Up  -->
<script src="<?php echo base_url();?>assets2/plugins/waypoints/lib/jquery.waypoints.min.js"></script>
<script src="<?php echo base_url();?>assets2/plugins/counterup/jquery.counterup.min.js"></script>

<!-- Knob -->
<script src="<?php echo base_url();?>assets2/plugins/jquery-knob/jquery.knob.js"></script>
<!-- multi select -->
<script type="text/javascript" src="<?php echo base_url();?>assets2/plugins/multiselect/js/jquery.multi-select.js"></script>
<!-- Peity chart js -->
<script src="<?php echo base_url();?>assets2/plugins/peity/jquery.peity.min.js"></script>
